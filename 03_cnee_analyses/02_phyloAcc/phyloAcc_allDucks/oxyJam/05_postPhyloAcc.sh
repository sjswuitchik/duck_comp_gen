# in /n/holyscratch01/informatics/swuitchik/ducks_project/ncbi_run/phyloAcc_allDucks/oxyJam/
...
for i in {0001..1000}; 
do
  shuf -n 186 galGal6_final_merged_CNEEs_named_sorted.bed > cnee_perms/'shuffle'$i.bed
done
...
for i in {0001..1000}; 
do
  shuf -n 186 ../galGal6_final_merged_CNEEs_named_sorted.bed > perms/'shuffle'$i.bed
done
