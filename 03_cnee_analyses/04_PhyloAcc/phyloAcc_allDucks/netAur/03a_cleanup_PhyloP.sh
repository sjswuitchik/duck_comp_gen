...
# in /n/holyscratch01/informatics/swuitchik/ducks_project/ncbi_run/phyloAcc_allDucks/netAur/PhyloAcc

conda activate phast 

# generate data to use in phyloP_cleanup_cnees.R to identify any CNEEs that show no evidence of conservation in all three topologies
