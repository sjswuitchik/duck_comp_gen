...
python3 core/hyphy-interface/hyphy_to_csv.py -i busted_out -o busted_output -m busted --overwrite
python3 core/hyphy-interface/hyphy_to_csv.py -i absrel_out -o absrel_output -m absrel --overwrite
