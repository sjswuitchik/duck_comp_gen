...
#conda create -n vcfqc -c bioconda plink vcftools bcftools r-base r-tidyverse admixture perl bedtools angsd
...
cp ../hetAtr_indvs .
vcftools --vcf hetAtr.filtered.vcf --max-missing 1 --min-alleles 2 --max-alleles 2 --out hetAtr.stair --recode --recode-INFO-all
