...
Code is being written and optimized, so will change frequently as analyses progress. As of July 22, 2020 - working on 03c_CAT, 05_CompPopGen, & zNCBI_run. Most up-to-date/optimized code will be in zNCBI_run as analyses are refined. 
