...
#conda install -c conda-forge pip zlib libblas liblapack libxml2
#pip install biocode 
python3 genbank2gff3.py -i GCA_001870855.1_T_cupido_pinnatus_GPC_3440_v1_genomic.gbff -o tymCupPin.gff
python3 genbank2gff3.py -i GCA_002592135.1_ASM259213v1_genomic.gbff -o ansBra.gff
python3 genbank2gff3.py -i GCA_003435085.1_NTU_Smik_1.2_genomic.gbff -o syrMik.gff
python3 genbank2gff3.py -i GCA_006130075.1_GSC_cangoose_1.0_genomic.gbff -o braCan.gff
python3 genbank2gff3.py -i GCA_006229135.1_ASM622913v1_genomic.gbff -o ansInd.gff
python3 genbank2gff3.py -i GCA_008692595.1_Cv_LA_1.0_genomic.gbff -o colVir.gff
