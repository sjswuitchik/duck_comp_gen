...
def sum_coverage_sbatch(sp_dir,sp_abbr):
    ...
    cmd_2 = 'python /n/holyscratch01/informatics/swuitchik/ducks_project/ncbi_run/05_CompPopGen/05_01_sum_coverage_subscript.py --sp_dir %s --sp_abbr %s'%(sp_dir,sp_abbr)
