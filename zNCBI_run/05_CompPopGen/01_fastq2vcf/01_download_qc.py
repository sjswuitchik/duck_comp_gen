...
def fastq_trim_align_stats(sp_dir,sra,sp_abbr,sample):
	...
	cmd_4 ='/n/holyscratch01/informatics/swuitchik/ducks_project/ncbi_run/05_CompPopGen/gatk-4.0.3.0/gatk --java-options "-Xmx8g -XX:ParallelGCThreads=6" SortSam -I %s/alignment/%s_bwa.sam -O %s/alignment/%s.sorted.bam --SORT_ORDER=coordinate --CREATE_INDEX=true --COMPRESSION_LEVEL 5'%(sp_dir,sra,sp_dir,sra)
