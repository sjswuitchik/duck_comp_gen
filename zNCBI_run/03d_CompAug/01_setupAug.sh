...
# top1 - seems to need a fully resolved tree? Will have to check with Tim. top1.nwk came from phyloP (/n/holylfs/LABS/informatics/swuitchik/ducks/03_cnees/cnees_ncbi_phyloP_top1.out)
for ali in *.maf;
do
id=${ali%.maf} 
augustus \
